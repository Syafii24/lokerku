...
&nbsp;FORM CETAK DATA LOWONGAN</div><!-- /.panel-heading -->
<div class="panel-body">
<div class="col-lg-12">
<div class="row">
<form role="form" action="<?php echo site_url().'/c_uas_31160014_abdullahsyafii/lowongan_cetak'?>" target="_blank" method="post" autocomplete="on" />
...
<div class="form-group">
	<button type="submit" class="btn btn-primary">CETAK DATA LOWONGAN</button>
