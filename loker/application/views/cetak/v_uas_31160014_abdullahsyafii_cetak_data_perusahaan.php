...
<br>
<h1 style="text-align: center;"><u>Laporan Data Perusahaan</u></h1><br><br>
...
<thead align="center">
	<tr>
		...
		<th width="150">DESKRIPSI PERUSAHAAN</th>
		<th width="100">WEBSITE</th>
		<th width="100">TELEPON</th>
		<th width="50">TANGGAL DIDIRIKAN</th>
	</tr>
</thead>
<tbody align="center">
<?php
if (! empty($perusahaan)) { 
	...
	foreach ($perusahaan->result() as $tampil) {
			$Tgl= date("d/m/Y",strtotime($tampil->tglberdiri));
			echo "<tr>";
			echo "<td>".$no."</td>";
			echo "<td>".$tampil->nm_perusahaan."</td>";
			echo "<td>".$tampil->alamat_perusahaan."</td>"; 
			echo "<td>".$tampil->deskripsi_perusahaan."</td>"; 
			echo "<td>".$tampil->web_perusahaan."</td>"; 
			echo "<td>".$tampil->telepon_perusahaan."</td>";
			echo "<td>".$Tgl."</td>";
			echo "</tr>";
			$no++;
	}
