...
<title>.. Cetak Kategori - PT. Sumber Alfaria Trijaya,Tbk</title>
<style type="text/css">
body, td, th {
	font-size: 10px;
}
...
<br>
<h1 style="text-align: center;"><u>Laporan Data Kategori</u></h1><br><br>
...
if (! empty($kategori)) { 
	...
	foreach ($kategori->result() as $tampil) {
			$Tgl= date("d/m/Y",strtotime($tampil->tgl_input));
			echo "<tr>";
			echo "<td>".$no."</td>";
...
<tfoot>
	<tr>
		<td colspan="2"><div align="right"><b>Jumlah Record</b></div></td>
